...
// Last-Updated: 日 2月 18 03:10:09 2024 (+0800)
//           By: Hongyi Wu(吴鸿毅)
//     Update #: 2
...
const unsigned short SamplingRate[MODNUMBER] = {125, 125};//Specify the sampling rate of each modules separately; 100/250/500 sampling rates; 0 to skip the module
const unsigned short Firmware[MODNUMBER] = {0, 2};//DPP_PHA=0 DPP_ZLE=1 DPP_PSD=2 DPP_DAW=3 OPEN=4 Scope=5
